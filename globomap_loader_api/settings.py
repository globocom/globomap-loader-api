...
GLOBOMAP_RMQ_VIRTUAL_HOST = os.getenv('GLOBOMAP_RMQ_VIRTUAL_HOST', 'globomap')
GLOBOMAP_RMQ_QUEUE_NAME = os.getenv(
    'GLOBOMAP_RMQ_QUEUE_NAME', 'globomap-updates')
GLOBOMAP_RMQ_EXCHANGE = os.getenv(
    'GLOBOMAP_RMQ_EXCHANGE', 'globomap-updates-exchange')
